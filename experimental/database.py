...
if __name__ == "__main__":
    #wizard = PresentationTemplateWizard("your_ppt_file_path.pptx")
    # template_model = wizard.wizard_cli()
    model = TemplateModel(
        template_name="science project",
        template_description="An engaging and modern PowerPoint template designed specifically for science students. Features vibrant color schemes, clean layouts, and dedicated sections for research data, findings, and visuals. Perfect for presentations in the classroom or at science fairs",
        ...
        slides=[
            ...
            SlideModel(
                slide_type="Transition Slide",
                page_number=2,
                placeholders=[
                    PlaceholderModel(
                        name="SUBTITLE",
                        description="The title of the upcoming slide.",
                        is_image=False,
                        image_width=None,
                        image_height=None,
                    )
            ...
            SlideModel(
                ...
                placeholders=[
                    ...
                    PlaceholderModel(
                        ...
                        description="Write a google search query for this image that is relevant to the topic.",
                        is_image=True,
                        image_width=213,
                        image_height=205,
                    ),
            ...
            SlideModel(
                slide_type="DOUBLE_COLUMN_CONTENT_SLIDE",
                page_number=5,
                placeholders=[
                    PlaceholderModel(
                        name="TITLE_SECTION",
                    ...
                    PlaceholderModel(
                        ...
                        description="Subtitle number one, The heading for a subtopic for the slide.",
                        is_image=False,
                        image_width=None,
                        image_height=None,
                    ),
                    PlaceholderModel(
                        name="SUBTITLE_SECTION_CONTENT",
                        description="The content for the SUBTITLE_SECTION/ subtitle one ",
                        is_image=False,
                        image_width=None,
                        image_height=None,
                    ),
                    PlaceholderModel(
                        ...
                        description="Second subtitle for the slide. Must be different to the first",
                        is_image=False,
                        image_width=None,
                        image_height=None,
                    ),
                    PlaceholderModel(
                        name="SUBTITLE_SECTION2_CONTENT",
                        description="The content for the second subtitle",
                        is_image=False,
                        image_width=None,
                        image_height=None,
                    ),
            ...
            SlideModel(
                slide_type="Content Slide Imageless",
                page_number=7,
                placeholders=[
                    PlaceholderModel(
                        name="TITLE_SECTION",
                    ...
                    PlaceholderModel(
                        name="CONTENT",
                        description="the content for the slide",
                        is_image=False,
                        image_width=None,
                        image_height=None,
                    ),
            ...
            SlideModel(slide_type="Thank you slide", page_number=8, placeholders=[]),
        ],
        file_extension=".pptx",
        word_limit_para=70,
        word_limit_points=30,
    )
    ...
    template_manager.create_template(model, "/home/zain/Downloads/Science_project_modified.pptx")