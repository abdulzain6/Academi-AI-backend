...
from api.rapid_api.universal_data_loader import router as universal_data_loader_router
...
app.include_router(universal_data_loader_router, prefix="/rapidapi/univeral_loader", tags=["univeral_loader"])
